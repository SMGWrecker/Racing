...
var userCarImage: String = "icons-1"

class ChangeCarCollectionViewController: UICollectionViewController {
    
    let cars = ["icons-1", "icons8-car", "icons8-sedan", "icons8-f1_car"]

    override func viewDidLoad() {
        super.viewDidLoad()

/* dellete        // Uncomment the following line to preserve selection between presentations
